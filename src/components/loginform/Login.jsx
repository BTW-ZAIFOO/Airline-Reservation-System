...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-linear-to-b from-blue-900 via-indigo-900 to-purple-800 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md bg-white/10 backdrop-blur-2xl rounded-3xl shadow-2xl p-10 z-10 transform hover:scale-[1.02] transition-all duration-500">
