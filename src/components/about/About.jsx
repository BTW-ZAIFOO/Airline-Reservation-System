      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-gray-600 text-lg max-w-2xl mx-auto">
            We provide seamless and safe air travel experiences worldwide. Our
            mission is to make your journey fast, reliable, and unforgettable.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-white rounded-3xl shadow-lg p-8 text-center hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-gray-600">
              Enjoy timely departures and arrivals with the highest safety
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 text-center hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-gray-600">
              Fly to over 500 destinations worldwide with our extensive network
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 text-center hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-gray-600">
              Our customer support team is always available to assist you at any
