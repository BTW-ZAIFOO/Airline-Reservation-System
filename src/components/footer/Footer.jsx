  ...
  return (
    <footer className="bg-blue-900 text-white py-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-300">
            Fly beyond limits with our seamless, fast, and reliable flight services worldwide.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link to="/flights" className="hover:text-yellow-400 transition">Flights</Link></li>
        ...
        <div>
          ...
          <p className="text-gray-300 mb-4">Subscribe for latest flight deals & updates</p>
          <div className="flex">
            <input
              type="email"
      ...
      <div className="border-t border-blue-700 mt-12 pt-6 flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto px-6 lg:px-16">
        <p className="text-gray-400 text-sm">&copy; 2025 AirFly. All rights reserved.</p>
        <div className="flex gap-4 mt-4 md:mt-0">
          <a href="#" className="hover:text-yellow-400 transition"><Facebook className="w-5 h-5" /></a>
          <a href="#" className="hover:text-yellow-400 transition"><Twitter className="w-5 h-5" /></a>
          <a href="#" className="hover:text-yellow-400 transition"><Instagram className="w-5 h-5" /></a>
          <a href="#" className="hover:text-yellow-400 transition"><Linkedin className="w-5 h-5" /></a>
        </div>
      </div>
    </footer>
  );
