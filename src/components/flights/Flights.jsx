...
// Example flight data (replace dynamically as needed)
const flightsData = [
  {
    from: "New York (JFK)",
    to: "London (LHR)",
    ...
    <section className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-extrabold text-gray-900">Available Flights</h2>
          ...
          {flightsData.map((flight, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">{flight.from} → {flight.to}</h3>
              </div>
