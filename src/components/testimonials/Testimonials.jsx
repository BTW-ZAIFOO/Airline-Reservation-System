...
// Example testimonials data (can be replaced or fetched dynamically)
const testimonialsData = [
  {
    name: "John Doe",
    role: "Frequent Traveler",
    avatar: "https://randomuser.me/api/portraits/men/32.jpg",
    message: "Booking flights has never been easier! The process is fast, reliable, and stress-free."
  },
  {
    name: "Jane Smith",
    role: "Business Traveler",
    avatar: "https://randomuser.me/api/portraits/women/44.jpg",
    message: "I love the global destinations and 24/7 support. This airline makes my business trips smooth."
  },
  {
    name: "Michael Lee",
    role: "Vacation Planner",
    avatar: "https://randomuser.me/api/portraits/men/56.jpg",
    message: "Amazing booking experience and great customer service. Highly recommended for family trips!"
  },
];
